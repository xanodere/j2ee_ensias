...
public class AppController {
	...
	@RequestMapping("/movies/list/{categorie}")
	public ModelAndView GetListby(@PathVariable("categorie") String category) {
		List<Movie> moviesList = appService.findMoviesByCategory(category);
		System.out.println(moviesList);
		ModelAndView mav = new ModelAndView();
		mav.addObject("movies", moviesList);
		mav.setViewName("categorie1");
		return mav;
	}
